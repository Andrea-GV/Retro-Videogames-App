...
export type PlatformWhereInput = {
  ...
  id_platform?: Prisma.IntFilter<"Platform"> | number
...
export type PlatformScalarWhereWithAggregatesInput = {
  ...
  id_platform?: Prisma.IntWithAggregatesFilter<"Platform"> | number
...
export type PlatformOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_platform" | "name", ExtArgs["result"]["platform"]>
...
export interface PlatformDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id_platform`
   * const platformWithId_platformOnly = await prisma.platform.findMany({ select: { id_platform: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Platforms and only return the `id_platform`
   * const platformWithId_platformOnly = await prisma.platform.createManyAndReturn({
   *   select: { id_platform: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more Platforms and only return the `id_platform`
   * const platformWithId_platformOnly = await prisma.platform.updateManyAndReturn({
   *   select: { id_platform: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PlatformFieldRefs {
  readonly id_platform: Prisma.FieldRef<"Platform", 'Int'>
