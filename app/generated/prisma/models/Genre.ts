...
export type GenreWhereInput = {
  ...
  id_genre?: Prisma.IntFilter<"Genre"> | number
...
export type GenreScalarWhereWithAggregatesInput = {
  ...
  id_genre?: Prisma.IntWithAggregatesFilter<"Genre"> | number
...
export type GenreOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_genre" | "name", ExtArgs["result"]["genre"]>
...
export interface GenreDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id_genre`
   * const genreWithId_genreOnly = await prisma.genre.findMany({ select: { id_genre: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Genres and only return the `id_genre`
   * const genreWithId_genreOnly = await prisma.genre.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Genres and only return the `id_genre`
   * const genreWithId_genreOnly = await prisma.genre.updateManyAndReturn({
   *   select: { id_genre: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface GenreFieldRefs {
  readonly id_genre: Prisma.FieldRef<"Genre", 'Int'>
